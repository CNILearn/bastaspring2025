...
public sealed partial class MainWindow : Window
{
    ...
    private void OnGridLoaded(object sender, RoutedEventArgs e)
    {
        if (Application.Current is App app)
        {
            var windowService = app.MyHost?.Services.GetRequiredService<DialogWindowService>() ?? throw new InvalidOperationException();
            windowService.XamlRoot = MainGrid.XamlRoot;
        }
    }
}
